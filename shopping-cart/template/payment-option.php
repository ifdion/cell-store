			<form id="payment-option" name="payment-option" class="well form-horizontal" action="<?php echo admin_url('admin-ajax.php'); ?>" method="post" enctype="multipart/form-data">
				<?php if ($_SESSION['shopping-cart']['payment']['shipping-destination-id']): ?>
					<?php
					...
					<div class="control-group">
						<div class="controls">
							<?php foreach ($shipping_option as $key => $value): ?>
								<?php
				...
				<div class="control-group">
					<div class="control-group">
						<div class="controls">
							...
							<label><input type="radio" id="" name="payment-method" value="Bank Mandiri" ><img class="payment-icon" src="<?php echo plugins_url('cell-store/img/bca.jpeg') ?>"> <?php _e('BCA', 'cell-store') ?></label><br>
