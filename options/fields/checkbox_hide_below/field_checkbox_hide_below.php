...
class NHP_Options_checkbox_hide_below extends NHP_Options{	
	...
	*/
	function render(){
		...
		echo '<input type="checkbox" id="'.$this->field['id'].'" name="'.$this->args['opt_name'].'['.$this->field['id'].']" value="1" class="'.$class.' cell-store-checkbox-hide-below" '.checked($this->value, '1', false).' />';
	...
	*/
	function enqueue(){
		...
		wp_enqueue_script(
			'cell-store-checkbox-hide-below-js', 
